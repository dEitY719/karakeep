...
- 토폴로지·동기화 규칙 전체는 [docs/architecture/system/pc-environment.md](docs/architecture/system/pc-environment.md) 참고.
...
[docs/architecture/system/pc-environment.md](docs/architecture/system/pc-environment.md) 를 참고하세요.
...
#42 를, **어느 PC 에서 어떤 op 를 도는지**(쓰기 경계)는
[docs/guides/llm-wiki-write-boundary.md](docs/guides/llm-wiki-write-boundary.md) 를 참고하세요.
