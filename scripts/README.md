...
### 원칙 ([docs/architecture/system/pc-environment.md](../docs/architecture/system/pc-environment.md) SSOT)
...
- 전체 vault 노트의 PC 간 공유는 git(`obsidian-para`) 기반이며 `vault-sync.sh` 가 자동화한다.
  자세한 내용은 [docs/architecture/system/pc-environment.md](../docs/architecture/system/pc-environment.md) §6 참조.
